...
export default class ApiHandler extends Component {
    ...
    sendSecurePostRequest(url, _body, onResponse, onError) {
        ...
        prefManager.getUserSessionData(data => {
            ...
            console.log("\x1b[36m%s\x1b[0m -------GETDATA SecPost APIHand------->>>", JSON.stringify(data.data?.token))
    ...
    sendSecureGetRequest(url, onResponse, onError) {
        ...
        prefManager.getUserSessionData(data => {
            ...
            Token = data.data?.token
            console.log("\x1b[36m%s\x1b[0m -------GET DATA IN APIHANDLER------->>>", JSON.stringify(data.data?.token))
    ...
    sendSecureImagePostRequest(url, _body, onResponse, onError) {
        ...
        prefManager.getUserSessionData(data => {
            token = data.data?.token
            console.log("\x1b[33m%s\x1b[0m -------IMAGE TOKEN------->>>", JSON.stringify(data.data?.token))
